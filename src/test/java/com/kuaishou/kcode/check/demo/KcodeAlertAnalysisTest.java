...
public class KcodeAlertAnalysisTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sourceFilePath1 = "D:\\JavaWorkspace\\kcodeData\\data1\\kcodeAlertForStudent-1.data";
        // ruleForStudent-1，报警规则
        String ruleFilePath1 = "D:\\JavaWorkspace\\kcodeData\\data1\\ruleForStudent-1.txt";
        // Q1Result-1.txt，第一问结果
        String q1ResultFilePath1 = "D:\\JavaWorkspace\\kcodeData\\data1\\Q1Result-1.txt";
        // Q2Result-1.txt，第二问输出和结果
        String q2ResultFilePath1 = "D:\\JavaWorkspace\\kcodeData\\data1\\Q2Result-1.txt";

        // 第二套数据集
        //kcodeAlertForStudent-2.data，原始监控数据
        String sourceFilePath2 = "D:\\JavaWorkspace\\kcodeData\\data2\\kcodeAlertForStudent-2.data";
        // ruleForStudent-2，报警规则
        String ruleFilePath2 = "D:\\JavaWorkspace\\kcodeData\\data2\\ruleForStudent-2.txt";
        // Q1Result-2.txt，第一问结果
        String q1ResultFilePath2 = "D:\\JavaWorkspace\\kcodeData\\data2\\Q1Result-2.txt";
